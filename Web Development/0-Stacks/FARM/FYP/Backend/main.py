...
import model
from model import projects, users, projectSentiments
from datetime import datetime
from reddit import redditApi
from newsApi import newsApi
from sentiment import getNews, updateProjectSentiment
from graphs import getGraphs, getSingleLineChart
...
def list_tables(db: Session = Depends(get_database_session)):
    with engine.connect() as conn:
        result = conn.execute("SELECT table_name FROM INFORMATION_SCHEMA.TABLES WHERE table_schema='fyp'")
